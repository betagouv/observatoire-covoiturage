INSERT INTO  perimeters.communes_2020(com,l_com,epci,l_epci,aom,l_aom,dep,l_dep,reg,l_reg,geom)
WITH temp as(
SELECT * FROM
json_to_recordset($1)
...
FROM temp a
LEFT JOIN perimeters.insee_perim_2020 b ON a.properties->>'INSEE_COM' = b.codgeo
...
LEFT JOIN perimeters.cerema_aom_2020 e ON a.properties->>'INSEE_COM' = e.com

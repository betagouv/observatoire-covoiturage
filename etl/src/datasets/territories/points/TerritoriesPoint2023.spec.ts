...
import { TerritoriesPoint2023 } from './TerritoriesPoint2023';
...
const Dataset = TerritoriesPoint2023;
const table = TerritoriesPoint2023.table;
test.before(async (t) => {
...
test.serial('should cleanup', async (t) => {
  ...
  const query = `DELETE FROM ${table} WHERE year = 2023`;

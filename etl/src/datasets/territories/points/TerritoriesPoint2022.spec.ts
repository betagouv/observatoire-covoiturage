...
import { TerritoriesPoint2022 } from './TerritoriesPoint2022';
...
const Dataset = TerritoriesPoint2022;
const table = TerritoriesPoint2022.table;
test.before(async (t) => {
...
test.serial('should cleanup', async (t) => {
  ...
  const query = `DELETE FROM ${table} WHERE year = 2022`;
